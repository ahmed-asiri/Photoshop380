...
public class DatabaseManager
{
  ...
  /**
   * Method to execute a query and return a list of strings
   * that is the first column data for all rows 
   * @param query the query to execute
   * @return a list of strings which is the result of
   * the query 
   */
  public List<String> getRowListForQuery(String query)
  {
  ...
  public static void main(String[] args)
  {
    ...
    // test a query               
    //dbManager.testQuery("Select FirstName, LastName, Age From Person " +
    //                    "Where Age > 30 OR LastName='Guzdial'",3);
   
    // test a query               
    //dbManager.testQuery("Select LastName, Age From Person " +
    //                    "Where Age < 30",2);
