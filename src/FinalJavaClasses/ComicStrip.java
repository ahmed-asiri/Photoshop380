...
public class ComicStrip extends JPanel
{
  ...
  {double amount = 25.0;
    ...
    Picture p1 = new Picture("c:/Alice/comic/panel1.jpg");
    p1.posterize();
    Picture p2 = new Picture("c:/Alice/comic/panel2.jpg");
    p2.posterize();
    Picture p3 = new Picture("c:/Alice/comic/panel3.jpg");
    p3.posterize();
    Picture p4 = new Picture("c:/Alice/comic/panel4.jpg");
    p4.posterize();
